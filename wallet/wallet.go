...
var (
	dumpto *string = flag.String("d", "", "Dump public addreses to the give file")
...
func main() {
	...
	fmt.Print("Enter wallet master password: ")
	pass := getpass()
	...
	if *dumpto!="" {
		...
		f.Close()
		fmt.Println("The public addresses saved in file", *dumpto)
		return
	}
}
