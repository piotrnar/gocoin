...
var _stealth_vecs = [][7]string { // x, y, k (z always 1) -> x,y,x, DH
	{
		...
		"92ce7268c8db6cbbe61a04b62aa03df0e658d12a48159ce94ebb1ea879650946", /*DH*/
	},
	{
		...
		"fe83702a7f15e7e980474b4e44be3ae5c0e7f2a7f137406a86825cd5d1fbe2bf", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"a66f90703e644ccda594bacdd60a7ac83914a62c5d504ae8ff7f741747dbe989", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"7c30c663cb7274d7b28d7de4a505a4979abaff5a07245a91a5013d382d4c60d0", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"6936038afbc690d6ca616ab4b2fef0646c2bd903a4ef234caed60b8f249ff45a", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
	...
	},
	{
		...
		"ff510911b5dffab35ac4385458db3f6d1508bbdfe958626fe0ad44e444493060", /*DH*/
	},
	{
		"f46a67e20804f956a1ce64566d96a42658a9a7a4c9a0be924615bef881a4a3f2",
		"3a8218cdf4156c60585f5721189289cc89500eab79480a109eb1d0684e560996",
		...
		"e44bacc12ab0ec8b878e838bfbaa3f7dd12d49b5bb7557b959ef3e0d3c4e8d1e", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"f7dcf105998d5bdf7ebed917276b8743ebde10cacb31b24258af33a617c9eab9", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"b45916b2eaac040ac67eeecfe556122b3180dce087a52c6722093b119ee75376", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"d5318d1d52b5ab4f494dbacf1dd1a102f86004d79a660900c2d30a846c9ffa0c", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"7a8e460017c9e6fd5937b6258e89dfdc681fc208f0746247067ca0d10be5194f", /*DH*/
	},
	{
		"79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798",
		"483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8",
		...
		"bbf33d5f530ae59254cea4977e2d7af3cf0f0d67f26adade9a9d9ac30f8b5793", /*DH*/
	},
}
...
func TestStealthDH(t *testing.T) {
	for i := range _stealth_vecs {
		...
		exp, _ := hex.DecodeString(_stealth_vecs[i][6])
