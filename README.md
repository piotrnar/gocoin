...
--------------
* No GUI application (a user needs to know how to use a command line).
* Works only with blocks - does not rely transactions, except from sending own transactions to the network.
...
The key that you want to import must be in base58 encoded format, which somehow looks like this:
